              ...
              <form onSubmit={handleUpdateProperty}>
                ...
                <div className="mb-4 ">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-md p-4 text-center cursor-pointer hover:bg-gray-50 h-40">
                    <img
                      src={uploadedImageUrl?uploadedImageUrl:singleProperty.image}
                      alt="Upload Image"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="agent-name"
                    name="agentName"
                    value={singleProperty?.agentName}
                    readOnly
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="agent-email"
                    name="agentEmail"
                    value={singleProperty?.agentEmail}
                    readOnly
                    className="w-full p-2 border border-gray-300 rounded-md bg-gray-100 focus:outline-none"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className='md:flex items-center gap-4'>
                    ...
                    <input
                      ...
                      name="minPrice"
                      required
                      defaultValue={singleProperty.price.minPrice}
                    ...
                    <input
                      ...
                      name="maxPrice"
                      required
                      defaultValue={singleProperty.price.maxPrice}
